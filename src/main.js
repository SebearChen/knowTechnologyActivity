...
router.beforeEach((to, from, next)=> {
  window.scrollTo(0,0);
  if (window.location.href.indexOf('activitycenter=1')>-1) {
    window.location.href = `${window.location.origin}${window.location.pathname}#/withdrawal?browser=commonWebView&showShareButton=1&fromApp=1`
  }
  if (to.meta.title) {
